...
%     \includegraphics[width=0.48\linewidth]{figures/ApplicationGenPhasePortrait.pdf}
...
%     \includegraphics[width=0.48\linewidth]{figures/ApplicationGenTwoParBifurcation1.pdf}
    \end{center}
